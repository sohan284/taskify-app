...
const CreatePrioritiesDialog = ({ open, onClose }) => {
  ...
  const handleCreate = () => {
    ...
    PriorityManagement.createPriority(newProject)
      .then(() => {
  ...
  return (
    <Dialog
      ...
      onClose={onClose}
    >
      <CloseDialog title="Create Priority" handleClose={onClose} />
...
CreatePrioritiesDialog.propTypes = {
