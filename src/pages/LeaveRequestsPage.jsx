...
import MeetingsTable from "../components/MeetingsPage/MeetingsTable";
import MeetingManagement from "../service/Meeting";
import CreateMeetingDialog from "../components/MeetingsPage/CreateMeetingDialog";
const LeaveRequestsPage = () => {
  ...
  return (
    <div className="lg:ml-64 mt-20 mx-2 sm:ml-64">
      ...
      <div>
        <MeetingsTable API={MeetingManagement.getMeetingList} />
      </div>
      <CreateMeetingDialog open={open} onClose={handleClose} />
    </div>
  );
};
